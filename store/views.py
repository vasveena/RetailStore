...
def ask_question(request):
    ...
    if 'question' in request.GET:
        ...
        prompt_template = """
            ...
            4. Use "like" and upper() for string comparison on both left hand side and right hand side of the expression. For example, if the query contains "jackets", use "where upper(product_name) like upper('%jacket%')". Do not use upper() on integer or non-string or non-varchar fields!
